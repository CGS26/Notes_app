...
#         mock_result.scalars.return_value = AsyncMock(return_value=mock_note)  # Mock scalars to return the note
#         mock_result.scalars.return_value.first = AsyncMock(return_value=mock_note)  # Mock first to return the note
